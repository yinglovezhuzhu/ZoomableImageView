 ...
 */
package com.opensource.widget.zoomableimageview;
...
import com.opensource.widget.zoomableimageview.gestures.IGestureDetector;
import com.opensource.widget.zoomableimageview.gestures.OnGestureListener;
import com.opensource.widget.zoomableimageview.gestures.GestureDetector;
import com.opensource.widget.zoomableimageview.scrollerproxys.ScrollerProxy;
...
public class ViewAttacher implements IZoomableImageView, View.OnTouchListener,
    ...
    private static final String LOG_TAG = "ViewAttacher";
        ...
        switch (scaleType) {
            case MATRIX:
                throw new IllegalArgumentException(scaleType.name()
                        + " is not supported in ZoomableImageView");
    ...
    private static void setImageViewScaleTypeMatrix(ImageView imageView) {
        /**
         * ZoomableImageView sets it's own ScaleType to Matrix, then diverts all calls
         * setScaleType to this.setScaleType automatically.
         */
        if (null != imageView && !(imageView instanceof IZoomableImageView)) {
    ...
    public ViewAttacher(ImageView imageView) {
        ...
        mScaleDragDetector = GestureDetector.newInstance(
    ...
    public ImageView getImageView() {
        ...
        if (null == imageView) {
            cleanup();
            Log.i(LOG_TAG,
                    "ImageView no longer exists. You should not use this ZoomableImageViewAttacher any more.");
        }
    ...
    private void checkImageViewScaleType() {
        ...
        /**
         * ZoomableImageView's getScaleType() will just divert to this.getScaleType() so
         * only call if we're not attached to a ZoomableImageView.
         */
        if (null != imageView && !(imageView instanceof IZoomableImageView)) {
            if (!ScaleType.MATRIX.equals(imageView.getScaleType())) {
                throw new IllegalStateException(
                        "The ImageView's ScaleType has been changed since attaching a ZoomableImageViewAttacher");
            }
        }
    }
